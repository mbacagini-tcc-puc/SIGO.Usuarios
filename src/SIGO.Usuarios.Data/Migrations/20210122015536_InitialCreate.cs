    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTimeOffset(new DateTime(2021, 1, 22, 1, 55, 35, 662, DateTimeKind.Unspecified).AddTicks(3945), new TimeSpan(0, 0, 0, 0, 0)), "usuarios", "Gerenciamento de Usuários" },
                    { 2, null, new DateTimeOffset(new DateTime(2021, 1, 22, 1, 55, 35, 662, DateTimeKind.Unspecified).AddTicks(4054), new TimeSpan(0, 0, 0, 0, 0)), "normas-tecnicas", "Normas Técnicas" },
                    { 3, null, new DateTimeOffset(new DateTime(2021, 1, 22, 1, 55, 35, 662, DateTimeKind.Unspecified).AddTicks(4060), new TimeSpan(0, 0, 0, 0, 0)), "assessorias-consultorias", "Assessorias e Consultorias" }
                });

            migrationBuilder.InsertData(
                table: "usuarios",
                columns: new[] { "id", "celular", "codigo_verificacao", "data_alteracao", "data_inclusao", "email", "expiracao_codigo_verificacao", "nome", "senha" },
                values: new object[] { 1, "AC6D5A87D5F3656E4D46A5224CD2D52A", null, null, new DateTimeOffset(new DateTime(2021, 1, 22, 1, 55, 35, 655, DateTimeKind.Unspecified).AddTicks(9706), new TimeSpan(0, 0, 0, 0, 0)), "6CA8AD90817B9A591E1EEDC5C183F4C9E4E2B32E1DD6EFDD688D2A47A0A83A79", null, "Administrador", "4c7ad029115071a8cdfaa17aae1a997b9e5f891033b771d38b79b07fd44a887909144ce6f015ed7b62efefdf6564079d7b4407db226065147dd1e48cc0a868df" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTimeOffset(new DateTime(2021, 1, 22, 1, 55, 35, 676, DateTimeKind.Unspecified).AddTicks(8433), new TimeSpan(0, 0, 0, 0, 0)), 1, 1, null },
                    { 2, null, new DateTimeOffset(new DateTime(2021, 1, 22, 1, 55, 35, 676, DateTimeKind.Unspecified).AddTicks(8513), new TimeSpan(0, 0, 0, 0, 0)), 2, 1, null },
                    { 3, null, new DateTimeOffset(new DateTime(2021, 1, 22, 1, 55, 35, 676, DateTimeKind.Unspecified).AddTicks(8516), new TimeSpan(0, 0, 0, 0, 0)), 3, 1, null }
                });
